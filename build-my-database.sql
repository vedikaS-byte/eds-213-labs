---  Main question: How do emissions from residential and non-residential buildings change across seasons, 
--                  and how do these patterns align with power plant emissions? 
...
SELECT s.source_name, s.iso3_country, SUM(e.emissions_quantity), s.capacity,
